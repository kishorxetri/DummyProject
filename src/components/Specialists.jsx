      ...
      <div className="container mx-auto px-4 md:px-[150px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {specialists.map((specialist) => (
            <div
              key={specialist.id}
              className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 relative group"
            >
              {/* Hover Line Animation */}
              <div className="absolute bottom-0 left-0 h-[2px] bg-[#3498db] w-0 group-hover:w-full transition-all duration-500 ease-in-out z-10"></div>
